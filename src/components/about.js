			...
			<ScrollView>
				<View style={{padding: 20}}>
					<Section>
						...
						<MyText style={{textAlign: 'center'}}>
							© 2017 Tanner (tanner.vc)
						</MyText>
					</Section>
					<Section>
						<MyText>
							This app was written by <MyLink url="http://tanner.vc">Tanner</MyLink> and based off a spreadsheet he created in university to help him finish electronics labs faster.
						</MyText>
					</Section>
					<Section>
						<MyText>
					...
					<Section>
						...
						<MyText>
							<MyLink url="https://github.com/tanner37/exact-resistor-calculator">https://github.com/tanner37/exact-resistor-calculator</MyLink>
						</MyText>
					</Section>
					<Section>
						<MyText>
